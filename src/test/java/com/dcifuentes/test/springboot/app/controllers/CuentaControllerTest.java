...
import com.dcifuentes.test.springboot.app.services.CuentaService;
...
import static com.dcifuentes.test.springboot.app.Datos.*;
...
class CuentaControllerTest {
    ...
    void testDetalle() throws Exception {
        ...
        // Then
                ...
                .andExpect(jsonPath("$.persona").value("Daniel"))
    ...
    void testListar() throws Exception {
        ...
        //Then
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$[0].persona").value("Daniel"))
